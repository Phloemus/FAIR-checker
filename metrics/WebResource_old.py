...
class WebResource:
    ...
    def __init__(self, url, rdf_graph=None) -> None:
        ...
        if rdf_graph is None:
            ...
            logger.info(f"Content-Type: {self.headers['Content-Type']}")
            logger.info(f"supported mimetypes: {self.mimetype}")
            ...
            if mimetype != "text/html":
                ...
                logger.info(f"Resource content_type is: {self.headers['Content-Type']}")
